...
create-argocd-myapp-kind-matrix-multi-clusters-multi-envs-and-status-check: ## Full setup for matrix (Git+Cluster) generator
	...
	$(MAKE) -f Makefile_Setup_ArgoCD_ApplicationSets_Using_Matrix_Multi_Clusters_Multi_Envs_Generator k8s-apply-myapp-matrix-manual-sync-applicationset-to-cluster; \
